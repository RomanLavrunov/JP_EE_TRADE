...
async function initCaseStudy() {
  try {
    ...
    const { exports_timeseries, imports_timeseries, share, epa_comparison, index_vs_2018, regional, world_exports_timeseries } = commoditiesData;
    ...
    // 04c Commodities — exports (CN44, CN85, CN28, CN71, CN90, CN94 + control CN03/04/95)
    buildTopCNChart(exports_timeseries);
    // Imports (CN87, CN84, CN85, CN90, CN32, CN33 + control CN03/04/95)
    ...
    renderSlopeChart(exports_timeseries, 'csSlopeCont', world_exports_timeseries);
    renderHeatmap(index_vs_2018, 'csHmCont');

    // Regional charts (CN44 wood + CN03 fish — from regional data)
